...
html_title = "DAE Tools Project Official Website"
...
# of the sidebar.
html_logo = "docs/[d][a][e]_Tools_project.png"

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = "docs/[d][a][e].ico"
...
latex_documents = [
  ('index', 'DAEToolsProject.tex', u'DAE Tools Project',
   u'by Dragan Nikolic', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = 'docs/[d][a][e]_Tools_project_latex.png'
...
man_pages = [
    ('index', 'daetoolsproject', u'DAE Tools Project',
     [u'Dragan Nikolic'], 1)
]
...
texinfo_documents = [
  ('index', 'DAE Tools Project', u'DAE Tools Project',
   u'Dragan Nikolic', 'DAE Tools Project', 'An object-oriented equation-based modelling, simulation and optimisation software.',
   'Miscellaneous'),
]
