...
public:
    ...
    modTutorial4(std::string strName, daeModel* pParent = NULL, std::string strDescription = "") 
...
public:
    simTutorial4(void) : model("cdaeTutorial4")
    {
        SetModel(&model);
    }
...
{ 
    std::unique_ptr<daeSimulation_t>    pSimulation  (new simTutorial4);
    ...
    pDataReporter->Connect("", "cdae_tutorial4-" + daetools::getFormattedDateTime());
