...
***********************************************************************************/
#ifndef CS_EVALUATOR_OPENMP_H
#define CS_EVALUATOR_OPENMP_H
...
namespace cs
{
class OPENCS_EVALUATORS_API csComputeStackEvaluator_OpenMP : public csComputeStackEvaluator_t
{
public:
    csComputeStackEvaluator_OpenMP(int noThreads = 0);
    virtual ~csComputeStackEvaluator_OpenMP();
