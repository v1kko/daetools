...
void csComputeStackEvaluator_Sequential::EvaluateEquations(csEvaluationContext_t EC,
                                                           real_t*               dofs,
                                                           real_t*               values,
...
void csComputeStackEvaluator_Sequential::EvaluateDerivatives(csEvaluationContext_t EC,
                                                             real_t*               dofs,
                                                             real_t*               values,
                                                             real_t*               timeDerivatives,
...
void csComputeStackEvaluator_Sequential::EvaluateSensitivityDerivatives(csEvaluationContext_t EC,
                                                                        real_t*               dofs,
                                                                        real_t*               values,
                                                                        real_t*               timeDerivatives,
                                                                        real_t*               svalues,
