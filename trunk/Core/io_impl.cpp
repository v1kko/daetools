...
void SaveEnum(xmlTag_t* pTag, const std::string& strEnumName, const daeeUnaryFunctions eValue)
{
    if(eValue == eSign)
        ...
        pTag->AddTag(strEnumName, string("eScaling"));
    else
        pTag->AddTag(strEnumName, strUnknown);
}
...
void SaveEnum(xmlTag_t* pTag, const std::string& strEnumName, const daeeVariableValueConstraint eValue)
{
    if(eValue == eNoConstraint)
        pTag->AddTag(strEnumName, string("eNoConstraint"));
    else if(eValue == eValueGTEQ)
        pTag->AddTag(strEnumName, string("eValueGTEQ"));
    else if(eValue == eValueLTEQ)
        pTag->AddTag(strEnumName, string("eValueLTEQ"));
    else if(eValue == eValueGT)
        pTag->AddTag(strEnumName, string("eValueGT"));
    else if(eValue == eValueLT)
        pTag->AddTag(strEnumName, string("eValueLT"));
    else
        pTag->AddTag(strEnumName, strUnknown);
}
...
void OpenEnum(xmlTag_t* pTag, const std::string& strEnumName, daeeVariableValueConstraint& eValue)
{
    string strValue;
    pTag->Open(strEnumName, strValue);

    if(strValue == "eValueGTEQ")
        eValue = eValueGTEQ;
    else if(strValue == "eValueLTEQ")
        eValue = eValueLTEQ;
    else if(strValue == "eValueGT")
        eValue = eValueGT;
    else if(strValue == "eValueLT")
        eValue = eValueLT;
    else
        eValue = eNoConstraint;
}
