...
#
# Created: Mon May  3 19:58:35 2010
...
class Ui_ChooseVariable(object):
    def setupUi(self, ChooseVariable):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("images/dialog-question.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ChooseVariable.setWindowIcon(icon)
        ...
        QtCore.QObject.connect(self.buttonCancel, QtCore.SIGNAL("clicked()"), ChooseVariable.reject)
        QtCore.QObject.connect(self.buttonOk, QtCore.SIGNAL("clicked()"), ChooseVariable.accept)
