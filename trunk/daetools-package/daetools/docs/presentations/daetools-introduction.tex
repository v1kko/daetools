...
\begin{frame}[plain]{Use Case 1 - Chemical Engineering}
    \begin{center}
        \alert{Simulation, optimisation, parameter estimation}
    \end{center}  
    {\small
      \begin{itemize}
        \item Sample models: 
            \begin{itemize}
                ...
                \item Batch crystalliser
                \item Discretised Population Balance equations
                \item Li-ion battery (Newman porous electrode theory) 
                \item Generalised Maxwell-Stefan equations for gas separation
            \end{itemize}
        \item Finite Element problems:
            \begin{itemize}
                \item Transient heat conduction/convection
                \item Cahn-Hilliard equation
                \item Flow through the porous media
            \end{itemize}
        \item Optimisation, parameter estimation and optimal control (Constrained Optimization Problem Set tests, COPS)
    \end{itemize}
    }
\end{frame}

\begin{frame}[plain]{Use Case 2 - Multi-scale modelling}
    \begin{center}
...
\begin{frame}{Use Case 2 - Multi-scale modelling (cont'd)}
    \begin{columns}[c]
...
\begin{frame}[plain]{Use Case 3 - Embedded simulator (back end)}
    \begin{center}
...
\begin{frame}[plain]{Use Case 4 - Web application / Web service}
    \begin{center}
        \alert{Network Interchange format for NEuroscience (NineML)}
    \end{center}   
