...
# For relative imports in tutorials
...
project = u'DAE Tools'
copyright = u'2009-2019, Dragan Nikolic'
...
texinfo_documents = [
  ('index', 'DAE Tools Project', u'DAE Tools Project Documentation',
   u'Dragan Nikolic', 'DAE Tools Project', 'Equation-based object-oriented modelling, simulation and optimisation software.',
   'Miscellaneous'),
]
