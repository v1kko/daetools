...
const daeVariableType area_t                      ("area_t",                       "m2",            0.0, 1.0e+05,     1.0, 1e-05);
const daeVariableType volume_t                    ("volume_t",                     "m3",            0.0, 1.0e+05,     1.0, 1e-06);
...
const daeVariableType fraction_t                  ("fraction_t",                   "-",        -1.0e-10, 1.1e+00,     0.1, 1e-06);
const daeVariableType no_t                        ("no_t",                         "-",        -1.0e+20, 1.0e+20,     0.0, 1e-05);

const daeVariableType moles_t                     ("moles_t",                      "mol",           0.0, 1.0e+20,     1.0, 1e-05);
const daeVariableType molar_flux_t                ("molar_flux_t",                 "mol/m2",   -1.0e+20, 1.0e+20,     0.0, 1e-05);
const daeVariableType molar_concentration_t       ("molar_concentration_t",        "mol/m3",        0.0, 1.0e+10,     1.0, 1e-05);
...
const daeVariableType heat_flux_t                 ("heat_flux_t",                  "W/m2",     -1.0e+20, 1.0e+20,     0.0, 1e-05);
const daeVariableType heat_transfer_coefficient_t ("heat_transfer_coefficient_t",  "W/(m2.K)",        0, 1.0e+10, 1.0e+02, 1e-05);
...
const daeVariableType density_t                   ("density_t",                    "kg/m3",         0.0, 1.0e+20, 1.0e+03, 1e-05);
...
const daeVariableType diffusivity_t               ("diffusivity_t",                "m2/s",          0.0, 1.0e+05, 1.0e-03, 1e-08);
