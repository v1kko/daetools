...
const char* DOCSTR_dt_array = "";
const char* DOCSTR_d = "";
const char* DOCSTR_d_array = "";
const char* DOCSTR_d2 = "";
const char* DOCSTR_d2_array = "";
...
const char* DOCSTR_daeDomainIndex = "";
    ...
    const char* DOCSTR_daeDomainIndex_init5 = "";
...
const char* DOCSTR_daeEquationExecutionInfo = "";
    ...
    const char* DOCSTR_daeEquationExecutionInfo_GetComputeStackInfo = "";
    const char* DOCSTR_daeEquationExecutionInfo_Name = "";
    const char* DOCSTR_daeEquationExecutionInfo_VariableIndexes = "";
    const char* DOCSTR_daeEquationExecutionInfo_DiffVariableIndexes = "";
...
const char* DOCSTR_daeEquation = "";
    ...
    const char* DOCSTR_daeEquation_SimplifyExpressions = "";
