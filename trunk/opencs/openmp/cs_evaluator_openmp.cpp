...
void csComputeStackEvaluator_OpenMP::EvaluateResiduals(csEvaluationContext_t EC,
                                                       real_t*               dofs,
                                                       real_t*               values,
...
void csComputeStackEvaluator_OpenMP::EvaluateJacobian(csEvaluationContext_t EC,
                                                      real_t*               dofs,
                                                      real_t*               values,
                                                      real_t*               timeDerivatives,
...
void csComputeStackEvaluator_OpenMP::EvaluateSensitivityResiduals(csEvaluationContext_t EC,
                                                                  real_t*               dofs,
                                                                  real_t*               values,
                                                                  real_t*               timeDerivatives,
                                                                  real_t*               svalues,
