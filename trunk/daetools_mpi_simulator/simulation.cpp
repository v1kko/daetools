                                 ...
                                 bool bCalculateSensitivities)
{
    ...
    call_stats::TimerCounter tc(tcs.SimulationInitialise);
    ...
    relativeTolerance      = dRelativeTolerance;
...
{
    auxiliary::daeTimesAndCounters& tcs = auxiliary::daeTimesAndCounters::GetTimesAndCounters();
    call_stats::TimerCounter tc(tcs.SimulationSolveInitial);
...
{
    auxiliary::daeTimesAndCounters& tcs = auxiliary::daeTimesAndCounters::GetTimesAndCounters();
    call_stats::TimerCounter tc(tcs.SimulationIntegration);
...
void daeSimulation_t::SaveStats()
{
    ...
    std::ofstream ofs;
    std::string filename = std::string("stats-") + std::to_string(model->mpi_rank) + ".json";
