...
***************************************************************/
    class_<daeDataReporterDomain, boost::noncopyable>("daeDataReporterDomain", DOCSTR_daeDataReporterDomain, no_init)
        .def(init<string, daeeDomainType, size_t, string>(( arg("self"),
                                                            arg("name"),
                                                            arg("type"),
                                                            arg("numberOfPoints"),
                                                            arg("units")
        ...
        .def_readonly("Units",       		&daeDataReporterDomain::m_strUnits,         DOCSTR_daeDataReporterDomain_Units)
    ...
    class_<daeDataReporterVariable, boost::noncopyable>("daeDataReporterVariable", DOCSTR_daeDataReporterVariable, no_init)
        .def(init<string, size_t, string>(( arg("self"),
                                            arg("name"),
                                            arg("numberOfPoints"),
                                            arg("units")
        ...
        .def_readonly("Units",       		&daeDataReporterVariable::m_strUnits,           DOCSTR_daeDataReporterVariable_Units)
...
***************************************************************/
    class_<daeDataReceiverDomain, boost::noncopyable>("daeDataReceiverDomain", DOCSTR_daeDataReceiverDomain, no_init)
        ...
        .def_readonly("Units",       		&daeDataReceiverDomain::m_strUnits,             DOCSTR_daeDataReceiverDomain_Units)
    ...
    class_<daeDataReceiverVariable, boost::noncopyable>("daeDataReceiverVariable", DOCSTR_daeDataReceiverVariable, no_init)
        ...
        .def_readonly("Units",       		&daeDataReceiverVariable::m_strUnits,           DOCSTR_daeDataReceiverVariable_Units)
