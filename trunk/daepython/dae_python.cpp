...
***************************************************************/
	...
	enum_<daeeInitialConditionMode>("daeeInitialConditionMode")
		...
		.value("eAlgebraicPart",	dae::core::eAlgebraicPart)
		.value("eDifferentialPart",	dae::core::eDifferentialPart)
		.export_values()
	;
...
/**************************************************************
	Global functions
***************************************************************/
	def("daeSaveModel", &daepython::daeSaveModel);		
...
***************************************************************/
    ...
    class_<daepython::daeSTNWrapper, bases<daeObject>, boost::noncopyable>("daeSTN")
        ...
        .def("SetActiveState",				&daepython::daeSTNWrapper::SetActiveState)
        ;
...
***************************************************************/
	...
	class_<daepython::daeDynamicActivityWrapper, bases<daeActivity_t>, boost::noncopyable>("daeDynamicActivity_t", no_init)
		...
		.def("ReportData",				pure_virtual(&daeDynamicActivity_t::ReportData))
		.def("Pause",					pure_virtual(&daeDynamicActivity_t::Pause))
		.def("Stop",					pure_virtual(&daeDynamicActivity_t::Stop))
	...
	class_<daepython::daeDynamicSimulationWrapper, bases<daeDynamicActivity_t>, boost::noncopyable>("daeDynamicSimulation_t", no_init)
		...
		.def("SetUpParametersAndDomains",	pure_virtual(&daeDynamicSimulation_t::SetUpParametersAndDomains))
		.def("SetUpVariables",				pure_virtual(&daeDynamicSimulation_t::SetUpVariables))
		;
	...
	class_<daepython::daeDefaultDynamicSimulationWrapper, bases<daeDynamicSimulation_t>, boost::noncopyable>("daeDynamicSimulation")
		...
		.def("Stop",						&daeDynamicSimulation::Stop)
