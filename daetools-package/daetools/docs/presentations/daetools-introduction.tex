...
\hypersetup{
    ...
    pdfkeywords = {Modelling, Simulation, Optimisation, Modelling languages, Model exchange,
                   Domain specific languages, Equation-based, DAE, Code generation},
...
\end{frame}
% 
% \begin{frame}\frametitle{Why \textsc{yet another} modelling software? (cont'd)}
...
% 
% \begin{frame}[plain]\frametitle{The fundamental concepts/software interfaces}
% \begin{columns}
...
% \end{frame}
% 
% \begin{frame}\frametitle{Package \textsc{core}}
% \scriptsize
% {
% \begin{table}
...
% \end{frame}
% 
% \begin{frame}\frametitle{Package \textsc{core} (cont'd)}
% \scriptsize
% {
% \begin{table}
...
% \end{frame}
% 
% \begin{frame}\frametitle{Package \textsc{core} - interface implementations}
%     \begin{center}
%         \begin{figure}
...
% \end{frame}
% 
% \begin{frame}\frametitle{Package \textsc{activity}}
% \scriptsize
% {
% \begin{table}
...
% \end{frame}
% 
% \begin{frame}\frametitle{Package \textsc{solvers}}
% \scriptsize
% {
% \begin{table}
...
% \end{frame}
% 
% \begin{frame}\frametitle{Package \textsc{solvers} - interface implementations}
%     \begin{center}
%         \begin{figure}
...
% \end{frame}
% 
% \begin{frame}\frametitle{Package \textsc{datareporting}}
% \scriptsize
% {
% \begin{table}
...
% \end{frame}
% 
% \begin{frame}\frametitle{Package \textsc{datareporting} - interface implementations}
%     \begin{center}
%         \includegraphics[width=0.8\paperwidth]{Supplemental_Figure_S6.png}      
%     \end{center}
% \end{frame}
% 
% \begin{frame}\frametitle{Package \textsc{log} and its interface implementations}
% \scriptsize
% {
% \begin{table}
...
% \end{frame}
% 
% \begin{frame}\frametitle{Package \textsc{units}}
% \scriptsize
% {
% \begin{table}
...
\begin{frame}
\frametitle{Use Case 4 - Multi-scale modelling (cont'd)}
    \begin{columns}[c]
